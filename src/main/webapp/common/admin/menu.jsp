...
<div class="container-fluid d-flex flex-column p-0">
    ...
    <ul class="nav navbar-nav text-light" id="accordionSidebar">
        ...
        <li class="nav-item" role="presentation"><a class="nav-link" href="admin-home"><i class="fas fa-user"></i><span>Profile</span></a></li>
        ...
        <li class="nav-item" role="presentation"><a class="nav-link" href="admin-home"><i class="far fa-user-circle"></i><span>Acount</span></a></li>
