                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <c:forEach var="item" items="${categories}">
                            <c:if test = "${not fn:startsWith(item.code, 'tho-')}">
                                <li><a class="dropdown-item" href="${pageContext.request.contextPath}/blog-post">${item.name}</a></li>
                                </c:if>
                            </c:forEach>

                        <li class="dropdown-submenu">
                            <a class="dropdown-item dropdown-toggle" href="${pageContext.request.contextPath}/blog-post">THƠ</a>
