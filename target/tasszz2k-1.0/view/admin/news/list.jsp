            ...
            <form action="<c:url value='/admin-news'/>" id="formSubmit" method="get">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <div class="row">
                            <div class="col-md-10">
                                <p class="text-primary m-0 font-weight-bold" style="padding-top: 7px;">List of articles</p>
                            </div>
                                    ...
                                    <div class="table-btn-controllers">
                                        <div class="pull-right tableTools-container">
                                            <div class="dt-buttons btn-overlap btn-group">
                                                <a flag="info" 
                                                   class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" data-toggle="tooltip" title="Add new article"
                                                   title="Add article" href='<c:url value="/admin-news?type=edit" />'>
                                                    <span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 align-self-center">
                                <p id="dataTable_info" class="dataTables_info" role="status" aria-live="polite">Showing ${(model.page-1)*5+1} to ${(model.page-1)*5+index-1} of ${model.totalPages*5}</p>
                            </div>
                            <div class="col-md-6">
